                    ...
                    addProcSubscription = client1.registerProcedure("com.example.add").subscribe(new Action1<Request>() {
                        ...
                        public void call(Request request) {
                            if (request.arguments() == null || request.arguments().size() != 1)
                            {
                            	...
                            	ObjectNode arrayNode = (ObjectNode)request.arguments().get(0);
                            	System.out.println(arrayNode);
                            	try {
									HeaterState hs = mapper.readValue(arrayNode.toString(), new TypeReference<HeaterState>() {});
        ...
        client2.statusChanged().subscribe(new Action1<WampClient.State>() {
            ...
            public void call(WampClient.State t1) {
                ...
                if (t1 instanceof WampClient.ConnectedState) {
                    ...
                    hs.setCurrentTemperature(33.3);
                    hs.setHeatingStrategy("Dummy");
                    Observable<Long> result1 = client2.call("com.example.add", Long.class, hs);
